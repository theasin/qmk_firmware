...
VALID_RGB_MATRIX_TYPES := AW20216 IS31FL3731 IS31FL3733 IS31FL3737 IS31FL3741 CKLED2001 WS2812 SN32F24x SN32F24xB custom
...
ifneq (,$(filter $(MCU), atmega16u2 atmega32u2 at90usb162))
    ...
    ifeq ($(strip $(RGB_MATRIX_DRIVER)), SN32F24x)
        OPT_DEFS += -DSN32F24x
        COMMON_VPATH += $(DRIVER_PATH)/led/sn32
        SRC += rgb_matrix_sn32f24x.c
    endif
