...
enum layer_keycodes {
    OPENRGB = SAFE_RANGE //Openrgb direct effect
};
...
*/
	...
	[_FN] = LAYOUT_65_ansi_blocker(
                ...
                RESET,   _______, _______, _______, _______, _______, _______, _______, RGB_HUD, RGB_HUI, _______, _______, OPENRGB,  KC_PAUSE, KC_INS,
