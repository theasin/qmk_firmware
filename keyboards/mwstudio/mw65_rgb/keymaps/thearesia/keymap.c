...
/*
       ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┐      /────\
       │Esc│ 1 │ 2 │ 3 │ 4 │ 5 │ 6 │ 7 │ 8 │ 9 │ 0 │ - │ = │ Bckspc│ VoD │ Hom │ VoU
       ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─────┼───┐ │     │
...
*/
	...
	[_BASE] = LAYOUT_65_ansi_blocker(
                ...
                KC_LCTL, KC_LGUI, KC_LALT, KC_VOLU, KC_VOLD,       KC_SPACE,                      MO(_FN), KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
...
void rgb_matrix_indicators_user(void) {
    if (host_keyboard_led_state().caps_lock) {
        rgb_matrix_set_color(52, 217, 71, 115); // assuming caps lock is at led #52
    }
}